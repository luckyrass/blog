...
import me.jdan.po.form.LoginForm;
...
public class LoginController {
    ...
    public String login(HttpServletRequest request, Model model,
                        @ModelAttribute("loginForm") LoginForm loginForm, RedirectAttributes redirectAttributes){
        Subject subject = SecurityUtils.getSubject();
        //UsernamePasswordToken token = new UsernamePasswordToken(loginForm.getUsername(), loginForm.getPassword());
        UsernamePasswordToken token = null;
        try {
            token = new UsernamePasswordToken(loginForm.getUser().getUsername(), loginForm.getUser().getPassword());
        } catch (Exception e) {
