...
<body>
    ...
    <article class="blogs">
        <h1 class="t_nav"><span>${categoryDesc}</span><a href="<c:url value="/index" />" class="n1">网站首页</a><a href="#" class="n2">${categoryName}</a></h1>
        ...
        <aside class="right">
            <div class="rnav">
                <ul>
                    <li class="rnav1"><a href="<c:url value="/detailStudy?type=algorithm" />">算法</a></li>
                    <li class="rnav2"><a href="<c:url value="/detailStudy?type=java" />">Java</a></li>
                    <li class="rnav3"><a href="<c:url value="/detailStudy?type=paper" />">论文</a></li>
                    <li class="rnav4"><a href="<c:url value="/detailStudy?type=experience" />">心得笔记</a></li>
                </ul>
            </div>
            <div class="news">
                <h3>
